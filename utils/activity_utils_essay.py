...
# Variables
inactivity_counter = 0  # Counter for inactivity events
...
def check_inactivity(root, inactivity_threshold, file_path):
    global last_mouse_activity, last_keyboard_activity, inactivity_counter
...
def start_activity_prevention(root, inactivity_entry, currently_running_label, currently_running_label2, start_button, stop_button, file_path):
    ...
    check_inactivity(root, inactivity_threshold, file_path)
